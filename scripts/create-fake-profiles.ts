...
// Configuration
const SUPABASE_URL = `https://cravqkjixynoxvgtzfje.supabase.co`;
const SUPABASE_SERVICE_ROLE_KEY = `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNyYXZxa2ppeHlub3h2Z3R6ZmplIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3MTQ4MjA5MSwiZXhwIjoyMDg3MDU4MDkxfQ.tRKyOAWTpwS4HaYuTXjYUBz12KsRxSpcvGLWv6e2w-8`;
